...
baseDir = fullfile(pwd, "2016");   % <- ZMIEN
...
manual.Pdc       = "InvPDC_kW_Avg";
manual.Gpoa      = "SEWSPOAIrrad_Wm2_Avg";
manual.Tmodule   = "SEWSModuleTemp_C_Avg";
manual.wind      = "WindSpeedAve_ms";
